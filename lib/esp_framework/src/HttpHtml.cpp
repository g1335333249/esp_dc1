...
const char HTTP_HTML_NAV_START[] PROGMEM =
    "</h1><div id='nav'><button onclick='tab(1)'class='active'>状态</button><button onclick='tab(2)'>联网</button><button onclick='tab(3)'>控制</button><button onclick='tab(4)'>安全</button><button onclick='tab(5)'>关于</button>";
...
const char HTTP_HTML_TAB_SECURITY_START[] PROGMEM =
    "<div id='tab4'><form method='post' action='/module_setting' onsubmit='postform(this);return false'><table class='gridtable'><thead><tr><th colspan='2'>安全设置</th></tr></thead><tbody>";

const char HTTP_HTML_TAB_SECURITY_END[] PROGMEM =
    "<tr><td colspan='2'><button type='submit' class='btn-info'>保存</button></td></tr></tbody></table></form></div>";

const char HTTP_HTML_TAB4_START[] PROGMEM =
    "<div id='tab5'><table class='gridtable'><thead><tr><th colspan='2'>硬件参数</th></tr></thead><tbody>";
...
const char HTTP_HTML_TAB5[] PROGMEM =
    "<div id='tab6'><div style='display:inline-block;color:#000000;min-width:340px;position:absolute;left:1%;margin-top:20px;width:99%'><textarea readonly id='log' cols='340' wrap='off' style='resize:none;width:98%;height:600px;padding:5px;overflow:auto;background:#ffffff;color:#000000;'></textarea></div></div>";
